import { pgTable, integer, timestamp, text, uniqueIndex } from "drizzle-orm/pg-core";
 ...
 * `id` and the tenant's text slug; uniqueness per tenant is enforced by
 * a partial unique index. The `id` column remains the PK to preserve
